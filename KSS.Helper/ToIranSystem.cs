...
namespace KSS.Helper
{
    ...
    public static class ConvertToIranSystem
    {
        ...
        private static readonly IDictionary<byte, byte> _charMapperCharIsNotFinal = new Dictionary<byte, byte>
        {
            {48 , 128}, // 0
            {49 , 129}, // 1
            {50 , 130}, // 2
        ...
        private static readonly IDictionary<byte, byte> _charMapperNextCharFinal = new Dictionary<byte, byte>
        {
            {198, 252}, //
            {200, 146}, //
            {201, 249}, //
        ...
        private static readonly IDictionary<byte, byte> _charMapperPreviousCharFinal = new Dictionary<byte, byte>
        {
           {195, 144},//أ
           {197, 144},//إ
           {199, 144},//ا
        ...
        private static readonly IDictionary<byte, byte> _charMapperPreviousCharNextCharFinal = new Dictionary<byte, byte>
        {
            {195, 144}, // أ
            {197, 144}, //إ
            {199, 144},//ا
        ...
        public static string EncodingConvert(this string input)
        {
            ...
            Encoding outputEncoding = Encoding.UTF32;

            //Encoding outputEncoding = Encoding.GetEncoding(1252);
