...
{
    public interface IBaseService<T, TViewDto, TAddDto, TUpdateDto>
        where T : class
        ...
        where TUpdateDto : class
    {
        ...
        Task AddDtoAsync(TAddDto item, bool saveChanges = true);
        ...
        void UpdateDto(TUpdateDto item, bool saveChanges = true);
        ...
        TViewDto Dto(T item);
        IEnumerable<TViewDto> Dto(IEnumerable<T> items);
        T AddDto(TAddDto item);
        IEnumerable<T> AddDto(IEnumerable<TAddDto> item);
    }
}